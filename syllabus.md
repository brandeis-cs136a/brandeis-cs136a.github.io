...
There is no required textbook. We will use selected chapters from [Speech and Language Processing (3rd ed. draft, web version: https://web.stanford.edu/\~jurafsky/slp3/](https://web.stanford.edu/~jurafsky/slp3/)), along with relevant conference and preprint papers. Additional required and recommended readings will be shared via Moodle posting. 
